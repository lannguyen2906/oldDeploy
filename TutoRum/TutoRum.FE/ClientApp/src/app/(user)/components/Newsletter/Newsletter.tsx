...
const Newsletter = () => {
  ...
  const info = () => {
    messageApi.success("Chúng tôi đã lưu thông tin email của bạn vào hệ thống");
  };
          ...
          <div className="col-span-12 bg-imagee">
            <div className="mb-10 mt-24 lg:mx-64 lg:my-24">
              ...
              <h3 className="text-base font-normal opacity-75 text-white text-center mb-8">
                Đăng ký nhận bản tin của chúng tôi để nhận ưu đãi, <br /> khuyến
                mãi và nhiều điều thú vị khác.{" "}
              </h3>
